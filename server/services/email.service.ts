...
export async function sendInterviewerAssignmentEmail(params: SendInterviewerAssignmentParams): Promise<SendEmailResult> {
  ...
  const subject = customSubject?.trim() || `Interview Assignment: ${roundName} for ${candidateName} — Virim Infotech`;
...
<body>
  <div class="container">
    ...
    <div class="content">
      <div style="font-size: 14px; color: #334155; line-height: 1.7; word-break: break-word;">
        ${escapedCustom}
      </div>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <p style="font-size: 14px; color: #334155;">
        You have been assigned to conduct an interview for <strong>${escapeHtml(candidateName)}</strong> for the <strong>${escapeHtml(positionLabel)}</strong> position.
      </p>
      ...
      <div class="card">
        ...
        <table style="width: 100%; font-size: 13.5px; border-collapse: collapse;">
          <tr><td style="padding: 4px 0; font-weight: 700; color: #475569; width: 120px;">Round:</td><td style="color: #0f172a;">${escapeHtml(roundName)}</td></tr>
          <tr><td style="padding: 4px 0; font-weight: 700; color: #475569;">Proposed Date:</td><td style="color: #0f172a;">${escapeHtml(scheduledDate)}</td></tr>
          <tr><td style="padding: 4px 0; font-weight: 700; color: #475569;">Proposed Time:</td><td style="color: #0f172a;">${escapeHtml(scheduledTime)}</td></tr>
          <tr><td style="padding: 4px 0; font-weight: 700; color: #475569;">Duration:</td><td style="color: #0f172a;">${durationMinutes} Minutes</td></tr>
          <tr><td style="padding: 4px 0; font-weight: 700; color: #475569;">Mode:</td><td style="color: #0f172a;">${escapeHtml(modeLabel)}</td></tr>
          <tr><td style="padding: 4px 0; font-weight: 700; color: #475569;">Location/Link:</td><td style="color: #0f172a;">${escapeHtml(locationText)}</td></tr>
        </table>
      </div>

      ${notes ? `<div style="background-color: #fffbeb; border: 1px solid #fde68a; border-radius: 8px; padding: 12px; font-size: 13px; color: #92400e; margin-bottom: 20px;"><strong>Recruiter Note:</strong> ${escapeHtml(notes)}</div>` : ''}
...
<head>
  ...
  <style>
    ...
    .header h2 { margin: 0; font-size: 20px; font-weight: 700; }
    .content { padding: 28px 24px; }
    .btn { display: inline-block; padding: 12px 24px; border-radius: 8px; font-weight: 700; text-decoration: none; font-size: 14px; }
    .btn-primary { background-color: #4f46e5; color: #ffffff !important; }
    .footer { border-top: 1px solid #f1f5f9; padding: 18px 24px; background-color: #fafafa; font-size: 12px; color: #64748b; text-align: center; }
  </style>
</head>
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div style="margin-top: 24px; padding-top: 16px; border-top: 1px solid #f1f5f9; font-size: 12.5px; color: #64748b;">
        If you need to reschedule or have any questions, please reply directly to this email or contact <strong>hr@viriminfotech.com</strong>.
      </div>
    </div>
    <div class="footer">
