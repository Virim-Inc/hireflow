...
function inspectConnections() {
    ...
    if (fs.existsSync(oldPath)) {
        const oldWf = JSON.parse(fs.readFileSync(oldPath, 'utf8'));
    ...
    if (fs.existsSync(newPath)) {
        const newWf = JSON.parse(fs.readFileSync(newPath, 'utf8'));
...
inspectConnections();
//# sourceMappingURL=inspect_duplicate_connections.js.map